# Physics Skills — Master Bibliography

All textbooks cited across `landau-graph`, `electrodynamics`, `plasma`,
`optics`, and `physics-conventions` skills. The **Short Name** column is
the canonical citation form used in node `Cross-References` sections.

## Primary Source Texts (by skill)

### Landau-Graph (Gaussian units)

| Short Name | Full Citation | KB Path |
|-----------|---------------|---------|
...
| Landau Vol.8 / LL8 | Landau & Lifshitz, *Электродинамика сплошных сред* (Electrodynamics of Continuous Media), 3rd ed., 2005 | `book/2005/2005--Электродинамика сплошных сред/` |
| Landau Vol.9 / LL9 | Landau & Lifshitz, *Статистическая физика. Часть 2* (Statistical Physics II), 3rd ed., 2001 | `book/2001/2001--Статистическая физика. Часть 2/` |
| Landau Vol.10 / LL10 | Landau & Lifshitz, *Физическая кинетика* (Physical Kinetics), 2nd ed., 2002 | `book/2002/2002--Физическая кинетика/` |

### Electrodynamics (SI units)

| Short Name | Full Citation | KB Path |
|-----------|---------------|---------|
| Jackson | J. D. Jackson, *Classical Electrodynamics*, 3rd ed., Wiley, 1998 | `book/1998/1998--Classical Electrodynamics (3rd Edition)/` |
| Griffiths | D. J. Griffiths, *Introduction to Electrodynamics*, 5th ed., Cambridge, 2023 | `book/2023/2023--Introduction to Electrodynamics (5th Edition)/` |
| Lechner | K. Lechner, *Classical Electrodynamics: A Modern Perspective*, Springer, 2018 | `book/2018/2018--Classical Electrodynamics A Modern Perspective/` |
| Avetissian | H. K. Avetissian, *Relativistic Nonlinear Electrodynamics*, Springer, 2006 | `book/2006/2006--Relativistic Nonlinear Electrodynamics/` |
| Born & Wolf | M. Born & E. Wolf, *Principles of Optics*, 7th ed., Cambridge, 1999 | `book/1999/1999--Principles of Optics (7th Edition)/` |
| Chew | W. C. Chew, *Waves and Fields in Inhomogeneous Media*, IEEE Press, 1995 | `book/1995/1995--Waves and Fields in Inhomogeneous Media (Chew)/` |
| Tai | C.-T. Tai, *Dyadic Green Functions in Electromagnetic Theory*, 2nd ed., IEEE Press, 1993 | `book/1993/1993--Dyadic Green Functions in Electromagnetic Theory (2nd Edition)/` |
| Bohren & Huffman | C. F. Bohren & D. R. Huffman, *Absorption and Scattering of Light by Small Particles*, Wiley, 1983 | `book/1983/1983--Absorption and Scattering of Light by Small Particles (Bohren)/` |
| Azzam & Bashara | R. M. A. Azzam & N. M. Bashara, *Ellipsometry and Polarized Light*, North-Holland, 1977 | (not in KB — cited via secondary sources) |
| Cao | 林璇英, 张之翔, *电动力学题解*, 2nd ed., 科学出版社, 2007 | `book/2006/2006--电动力学题解 (第二版)/` |

### Plasma (SI units)

| Short Name | Full Citation | KB Path |
|-----------|---------------|---------|
| Stix | T. H. Stix, *Waves in Plasmas*, AIP, 1992 | `book/1992/1992--Waves in Plasmas (Stix)/` |
| Ginzburg | V. L. Ginzburg, *Распространение электромагнитных волн в плазме* (Propagation of EM Waves in Plasma), 2nd ed., Nauka, 1967 | `book/1967/1967--Распространение электромагнитных волн в плазме (2-е изд.)/` |
| Chen | F. F. Chen, *Introduction to Plasma Physics and Controlled Fusion*, 3rd ed., Springer, 2016 | `book/2016/2016--Introduction to Plasma Physics and Controlled Fusion/` |
| Friedberg | J. P. Friedberg, *Ideal Magnetohydrodynamics*, Plenum, 1987 | `book/1987/1987--Ideal Magnetohydrodynamics/` |
| Handbook PP-1 | *Handbook of Plasma Physics*, Vol. 1 (Basic Plasma Physics), North-Holland, 1984 | `book/1984/1984--Handbook of Plasma Physics Part 1/` |
| Handbook PP-3 | *Handbook of Plasma Physics*, Vol. 3 (Physics of Laser Plasma), North-Holland, 1991 | `book/1991/1991--Handbook of Plasma Physics Vol 3_ Physics of Laser Plasma/` |
| Gurnett & Bhattacharjee | D. A. Gurnett & A. Bhattacharjee, *Introduction to Plasma Physics*, 2nd ed., Cambridge, 2020 | `book/2020/2020--Introduction to Plasma Physics with Space and Laboratory Applications (2nd Edition)/` |
| Fitzpatrick | R. Fitzpatrick, *Introduction to Plasma Physics*, 2006 | `book/2006/2006--Introduction to Plasma Physics (Fitzpatrick)/` |
| Bellan | P. M. Bellan, *Fundamentals of Plasma Physics*, Cambridge, 2006 | `book/2006/2006--Physics of Strongly Coupled Plasma/` (NB: Bellan not in KB; cross-check) |
| Shah | V. Shah, *Plasma and Plasmonics*, De Gruyter, 2018 | `book/2018/2018--Plasma and Plasmonics/` |
| Kruer | W. L. Kruer, *The Interaction of High-Power Lasers with Plasmas*, Addison-Wesley, 2002 | `book/2002/2002--The Interaction of High-Power Lasers with Plasmas/` |
| Macchi | A. Macchi, *A Superintense Laser-Plasma Interaction Theory Primer*, Springer, 2013 | `book/2013/2013--A Superintense Laser-Plasma Interaction Theory Primer/` |
| Gibbon | P. Gibbon, *Short Pulse Laser Interactions with Matter*, Imperial College Press, 2005 | `book/2005/2005--Short Pulse Laser Interactions with Matter/` |
| Hutchinson | I. H. Hutchinson, *Principles of Plasma Diagnostics*, 2nd ed., Cambridge, 2002 | `book/2002/2002--Principles of Plasma Diagnostics 2nd edition/` |

### Optics (SI units)

| Short Name | Full Citation | KB Path |
|-----------|---------------|---------|
| Goodman | J. W. Goodman, *Introduction to Fourier Optics*, 4th ed., Freeman, 2017 | `book/2017/2017--Introduction to Fourier Optics (4th Edition)/` |
| Siegman | A. E. Siegman, *Lasers*, University Science Books, 1986 | `book/1986/1986--Lasers (Revised)/` |
| Svelto | O. Svelto, *Principles of Lasers*, 5th ed., Springer, 2010 | `book/2010/2010--Principles of Lasers/` |
| Trebino | R. Trebino, *Frequency-Resolved Optical Gating*, Kluwer, 2000 | `book/2000/2000--Frequency-Resolved Optical Gating_ The Measurement of Ultrashort Laser Pulses/` |
| Boyd | R. W. Boyd, *Nonlinear Optics*, 4th ed., Academic Press, 2020 | `book/2020/2020--Nonlinear Optics (4th Edition)/` |
| Yariv & Yeh | A. Yariv & P. Yeh, *Optical Waves in Crystals*, Wiley, 1984 | `book/1984/1984--Optical Waves in Crystals/` |
| Marcuse | D. Marcuse, *Light Transmission Optics*, 2nd ed., Van Nostrand, 1982 | `book/1982/1982--Light Transmission Optics (2nd Edition)/` |
| Okamoto | K. Okamoto, *Fundamentals of Optical Waveguides*, 2nd ed., Academic Press, 2006 | `book/2006/2006--Fundamentals of Optical Waveguides (2nd Edition)/` |
| Saleh & Teich | B. E. A. Saleh & M. C. Teich, *Fundamentals of Photonics*, 1st ed., Wiley, 1991 | `book/1991/1991--Fundamentals of Photonics (1st Edition)/` |
| Iizuka | K. Iizuka, *Engineering Optics*, 4th ed., Springer, 2019 | `book/2019/2019--Engineering Optics (4th Edition)/` |
| Jarem & Banerjee | J. M. Jarem & P. P. Banerjee, *Computational Methods for Electromagnetic and Optical Systems*, 2nd ed., CRC, 2011 | `book/2011/2011--Computational Methods for Electromagnetic and Optical Systems/` |
| Carcione | J. M. Carcione, *Wave Fields in Real Media*, 4th ed., Elsevier, 2022 | `book/2022/2022--Wave Fields in Real Media (Fourth Edition)/` |
...
### In-Node Reference Format

In every node's `Cross-References` section, use the canonical **Short Name**
from this bibliography followed by section numbers where relevant:

```
- Jackson §7.3-7.4, Griffiths §9.3, Born & Wolf §1.5
- Boyd §7, Siegman §9-10, Agrawal §2-5
- Stix §1-2, Ginzburg §3-5, Chen §4
```

### Canonical Format Rules

1. **Always use the Short Name exactly as listed above.** Never use variants
   (e.g., not "Born&Wolf" but "Born & Wolf"; not "Jackson 3rd" but "Jackson").
2. **Section references use §** (Unicode SECTION SIGN, U+00A7), not "Ch." or "Sec."
3. **No publisher/year after the name** — that's what this bibliography is for.
4. **Landau references**: use "Landau Vol.N" or "LLN" for brevity in
   cross-references (both are acceptable; prefer "Landau Vol.2" in formal text).
5. **Multi-author names**: use "&" not "and" — Born & Wolf, Yariv & Yeh, etc.
6. **Russian names**: use English transliteration (Ginzburg, not Гинзбург;
   Landau, not Ландау).

### First-Mention Rule

In the `Derivation Sketch` or `Core Picture` section (first significant mention
of a source), you may include a full citation once. All subsequent mentions
use Short Name + § only.
...
These sources are cited in nodes but **not** present in `/home/zhiping/knowledge_base/book/`.
Flagged with `[square brackets]` in node cross-references. Consider acquiring for future rounds.

| Short Name | Full Citation | Status |
|-----------|---------------|--------|
| [Wesson] | J. Wesson, *Tokamaks*, 4th ed., Oxford, 2011 | Not in KB — standard tokamak reference |
| [Raether] | H. Raether, *Surface Plasmons*, Springer, 1988 | Not in KB — cited in surface_waves_plasmonics |
